...
exports.migrateStoriesSchematic = exports.getTsSourceFile = exports.findAllAngularProjectsWithStorybookConfiguration = exports.migrateStoriesTo62Generator = void 0;
...
function findAllAngularProjectsWithStorybookConfiguration(tree) {
    ...
    const projectsThatHaveStorybookConfiguration = (_b = (_a = [...projects.entries()]) === null || _a === void 0 ? void 0 : _a.filter(([_, projectConfig]) => projectConfig.targets &&
        projectConfig.targets.storybook &&
        projectConfig.targets.storybook.options &&
        projectConfig.targets.storybook.options.uiFramework ===
            '@storybook/angular')) === null || _b === void 0 ? void 0 : _b.map(([projectName, projectConfig]) => {
...
exports.default = migrateStoriesTo62Generator;
exports.migrateStoriesSchematic = (0, devkit_1.convertNxGenerator)(migrateStoriesTo62Generator);
