...
function storybookExecutor(options, context) {
    return tslib_1.__asyncGenerator(this, arguments, function* storybookExecutor_1() {
        ...
        if ((0, utils_1.isStorybookLT6)()) {
            (0, utilities_1.showStorybookV5Warning)(options.uiFramework);
        }
...
function runInstance(options) {
    ...
    return (0, core_server_1.buildDevStandalone)(Object.assign(Object.assign({}, options), { ci: true, configType: env.toUpperCase() })).catch((error) => {
        var _a;
